...
let convertLowerCase = (value) =>{
  return value.toLowerCase();
}

// let test = convertLowerCase("CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO");
// console.log(test)
...
let charString = (value1, value2) =>{
    return value2.indexOf(value1);
}

// console.log(charString("p", "Felipe"));
/*
  05
