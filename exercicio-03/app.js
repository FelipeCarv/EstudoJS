...
brazilianFoods[2] = "Pão de queijo";
...
const foodsInfo = "Até aqui, o array \"brazilianFoods\" possui " +brazilianFoods.push() + " itens: " +brazilianFoods[0] + ", " + brazilianFoods[1] + ", " + brazilianFoods[2]
