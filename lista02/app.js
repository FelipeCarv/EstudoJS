...
let texto = "Grandes poderes trazem grandes responsabilidades.";
// console.log(texto);
...
let randomWord = 'Otorrinolaringologista'
let lastLetter = randomWord.length;
// console.log(randomWord[lastLetter - 1]);
...
const realBestMovie = bestMovie.slice(0, 36);
// console.log(realBestMovie + "MoonLight!");
...
console.log(`${newName[0]}`.toLowerCase() + `${newName}`.slice(1,6) + " " + `${newName[7]}`.toLowerCase() + `${newName}`.slice(8,12));
