...
const my3FavoriteTVShows = ["LORT", "GoT", "The Witcher"];
const setence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows[0]}, ${my3FavoriteTVShows[1]} e ${my3FavoriteTVShows[2]}.`
